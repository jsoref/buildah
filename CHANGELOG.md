...
## v1.18.0 (2020-11-16)
    Fix testing error caused by simultaneous merge
...
## v1.14.7 (2020-04-07)
    ...
    Downgrade sirupsen/logrus from 1.4.2
...
## v1.14.1 (2020-02-27)
    ...
    Stop using fedoraproject registry
...
## v1.5-1 (2018-11-21)
    ...
    Update imagebuild dependency to support heading ARGs in Dockerfile
...
## 1.1 (2018-06-08)
    ...
    Added demo dir and a demo. changed distrorelease
